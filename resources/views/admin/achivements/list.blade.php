                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                    <div class="mb-6 lg:mb-0 flex flex-col items-center lg:items-start text-center lg:text-left">
                        <div class="flex items-center mb-3">
                            ...
                            <div>
                                <h1 class="text-3xl font-bold text-gray-900">Achievement Management</h1>
                            </div>
                        </div>
                        <p class="text-gray-700 bg-white/70 backdrop-blur-sm px-4 py-2 rounded-lg inline-block shadow-sm">
                            Manage your achievements effectively
                        </p>
                    </div>

                    <div class="flex flex-wrap gap-3 justify-center lg:justify-end">
                        <a href="{{ route('achivements.create-achivements') }}" class="group">
            ...
            <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-white/50 overflow-hidden">
                <div class="p-8">
                    ...
                    <div class="overflow-hidden rounded-xl border border-gray-200/60">
                        <div class="">
                            <table id="achievementTable" class="w-full">
                                <thead>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#achievementTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('achivements.get-achivements') }}',
                    type: 'GET',
                ...
                language: {
                    processing: '<div class="flex items-center justify-center py-8"><div class="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600"></div><span class="ml-3 text-gray-700">Loading achievements...</span></div>',
                    search: '',
                    searchPlaceholder: 'Search achievements...',
                    info: 'Showing _START_ to _END_ of _TOTAL_ achievements',
                    infoEmpty: 'No achievements found',
                    infoFiltered: '(filtered from _MAX_ total achievements)',
                    lengthMenu: 'Show _MENU_ achievements per page',
                    zeroRecords: '<div class="text-center py-8"><div class="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4"><i class="fas fa-trophy text-gray-400 text-2xl"></i></div><h3 class="text-lg font-semibold text-gray-900 mb-2">No achievements found</h3><p class="text-gray-600">Try adjusting your search criteria or add your first achievement.</p></div>',
                    paginate: {
                ...
                drawCallback: function(settings) {
                    ...
                    $('#achievementTable tbody tr').hover(
                        function() {
            ...
            $('#achievementTable').on('processing.dt', function(e, settings, processing) {
                if (processing) {
