        ...
        <main>
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
                <div class="bg-white rounded-lg shadow-md p-8">
                    <h2 class="text-3xl font-bold text-gray-800 mb-8 text-center">Edit Event Details</h2>

                    <form action="{{ route('event.update-event', encrypt($event->id)) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            <label for="topic" class="block text-sm font-medium text-gray-700 mb-2">
                                Event Topic <span class="text-red-500">*</span>
                            </label>
                            <input
                                type="text"
                                name="topic"
                        ...
                        <div>
                            ...
                            >
                            <p class="mt-1 text-sm text-gray-500">Upload a new main event image (optional - leave empty to keep current image)</p>

                            @if(isset($event->main_image) && $event->main_image)
                                <div class="mt-3" id="current-main-image">
                                    <p class="text-sm text-gray-600 mb-2">Current Main Image:</p>
                                    <div class="relative inline-block">
                                        <img src="{{ asset('storage/eventsimage/' . $event->main_image) }}" alt="Current main image" class="w-48 h-32 object-cover rounded-lg shadow-sm">
                                ...
                                @if(isset($event->gallery_images) && count($event->gallery_images) > 0)
                                    <div class="mt-4">
                                        ...
                                        <p class="text-xs text-gray-500 mt-2">
                                            ...
                                            {{ count($event->gallery_images) }} existing gallery image(s). New images will be added to this collection.
                                        </p>
                                    </div>
                                @endif
