                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                    <div class="mb-6 lg:mb-0 flex flex-col items-center lg:items-start text-center lg:text-left">
                        ...
                        <p class="text-gray-700 bg-white/70 backdrop-blur-sm px-4 py-2 rounded-lg inline-block shadow-sm">
                            Manage your testimonial effectively
                        </p>
                    </div>

                    <div class="flex flex-wrap gap-3 justify-center lg:justify-end">
                        <a href="{{ route('testimonial.create-testimonial') }}" class="group">
        ...
        $(document).ready(function() {
            ...
            var table = $('#testimonialTable').DataTable({
                ...
                language: {
                    ...
                    infoEmpty: 'No testimonial found',
                ...
                drawCallback: function(settings) {
                    ...
                    $('#testimonialTable tbody tr').hover(
                        function() {
            ...
            $('#testimonialTable').on('processing.dt', function(e, settings, processing) {
                if (processing) {
